...
$template->add_region('content', $html); } else {
  ...
  $html .= $year < 2017 ? "<p style=\"font-size: 120%\"><strong>Note: data collection methods changed in 2017.  Zero values below may reflect data not collected, not totals of zero." : "";
...
. "<th align=\"center\">Other day support<br />wrap-around services</th>";
  ...
  . "<th align=\"center\">Individual<br />competitive<br />employment</th>"
    ...
    $html  .= "<th colspan=\"3\" align=\"center\">Mean hours of participation by activity</th>"
        . "<th colspan=\"3\" align=\"center\">Percent of total paid work hours</th>"
        . "</tr><tr><th align=\"center\">Individual<br />competitive<br />employment</th>"
        . "<th align=\"center\">Group<br />integrated<br />employment</th>"
        . "<th align=\"center\">Facility<br />based<br />employment</th>"
  ...
  if($f['year'] >= 2017)  {
      ...
      $html  .= "<tr><th rowspan=\"2\">Provider</th><th rowspan=\"2\">Total Served<br />(unduplicated count)</th>"
          ...
          . "<th colspan=\"3\" align=\"center\">Mean wage for reporting period</th>"
          . "<th colspan=\"3\" align=\"center\">Total wages for reporting period</th>"
          . "</tr><tr><th align=\"center\">Individual<br />competitive<br />employment</th>"
