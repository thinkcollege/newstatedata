...
$cols	= dds::getRegionColumnNamesArray($f['year']);
$colors = array("9900CC", "FF9900", "993333"); //purple, orange, brown

$template->add_region('heading', "Provider Report " . ($f['year'] ? "for {$f['year']}" : "for all years" ));
