...
$values	= implode(';', dds::getRegionVariableArray($var, $f['year']));
$cats	= preg_replace('/(^|;)x_/i', '\\1', implode(';', dds::getRegionColumnNamesArray($f['year'])));
$axis	= dds::getRegionAxisLabel($var);
$legend	= dds::getRegionLegendName($var, $f['year']);
...
if (!$print) {
	$html .= "<br><a target=\"_new\" href=\"region_2.php?print=1&amp;variable=$var&amp;" . dds::serializeFilters() . "\">Printer-Friendly Format</a>";
}
