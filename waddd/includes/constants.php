...
define('ALT_USER', 'statedata_user');
define('ALT_PASS', 'dd5566tty');
define('ALTDATABASE', 'statedata');
define('PRE_TABLE', '');
...
define('SD_BILLING',         '`' . PRE_TABLE . 'sta_ps_billing`');
define('SD_EMPLOYMENT',	'`' . PRE_TABLE . 'sta_ps_employment`');
define('SD_CODE_LOOKUP',     '`' . PRE_TABLE . 'sta_ps_code_lookup`');
define('SD_PROVIDER',        '`' . PRE_TABLE . 'sta_ps_orgs_wa`');
