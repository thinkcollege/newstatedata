...
$template->add_region('heading','About The DDS Employment Supports Performance Outcome Information System');
...
<h3 style="margin-bottom:2em;" id="toc_3"><a href="/dds2::/Maryland_DDA_Outcome_Information_System_FAQ_2018.pdf">FAQ (PDF)</a></h3>
<hr>
');
//write page
include("header.php");
