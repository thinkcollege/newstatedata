...
$values	= implode(';', dds2::getRegionVariableArray($var, $f['year']));
$cats	= preg_replace('/(^|;)x_/i', '\\1', implode(';', dds2::getRegionColumnNamesArray($f['year'])));
$axis	= dds2::getRegionAxisLabel($var);
$legend	= dds2::getRegionLegendName($var, $f['year']);
...
if (!$print) {
	$html .= "<br><a target=\"_new\" href=\"region_2.php?print=1&amp;variable=$var&amp;" . dds2::serializeFilters() . "\">Printer-Friendly Format</a>";
}
