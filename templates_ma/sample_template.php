...
<li><a href="<?php echo $file_path ?>sample/charts/activity_1.php">Summary Reports <img src="<?php echo $file_path ?>images/arrow_<?if ($area == "activity") { echo "on"; } else {echo "off";} ?>.gif" width="4" height="8" alt="" border="0"></a></li>
